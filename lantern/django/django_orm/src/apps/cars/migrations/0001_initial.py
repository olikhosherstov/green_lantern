    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firstRegistrationDate', models.DateField(null=True)),
                ('enginePower', models.DecimalField(decimal_places=2, max_digits=6, null=True)),
        ...
        migrations.AddConstraint(
            model_name='carengine',
            constraint=models.UniqueConstraint(fields=['name'], name='unique-car-engine'),
        ),
        migrations.AddIndex(
            model_name='carbrand',
